...
def evaluate_samples(
    ...
    *,
    ...
    A sample is eligible at length ``n`` only if it produced at least ``n``
    textual tokens. Each eligible prefix contributes either one canonical or
    one non-canonical sequence; no token-level averaging is performed.
    """
